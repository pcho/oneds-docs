...
Reporting allows users to generate, customize, export, and schedule data summaries and analytics. In IP management, reports track portfolio status, deadlines, costs, filing statistics, and compliance metrics.
...
- Padding: 24px
- Background: White
- Border radius: 12px (modal)

Sections:
- Gap: 24px between sections
- Label: 14px, font weight 600, #2A353F
- Description: 12px, #7E8A96
...
- Announce report generation progress
- Read report parameters clearly
- Describe export format options
- Announce completion or errors
- Read scheduled report details
...
```html
<form aria-labelledby="report-builder-title">
  <h2 id="report-builder-title">Generate Report</h2>

  <label for="report-type">Report type:</label>
  <select id="report-type" aria-describedby="report-type-help">
    <option>Portfolio Summary</option>
  </select>
  <div id="report-type-help" role="tooltip">
    Select the type of report to generate
  </div>

  <div role="status" aria-live="polite" aria-atomic="true">
    <!-- Report generation status announcements -->
  </div>
</form>
```
...
- Support standard formats (PDF, Excel, CSV)
- Include metadata in exports
- Maintain formatting in exports
- Handle large datasets efficiently
- Provide compression for large files
