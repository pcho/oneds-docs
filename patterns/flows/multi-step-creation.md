...
The multi-step creation pattern guides users through complex workflows by breaking them into manageable, sequential steps. Think of it as a journey with clear milestones—each step focuses on one specific task, reducing cognitive load while maintaining context and progress visibility throughout the entire process.

This pattern is used consistently across IP Right creation, Design registration, and Trademark filing workflows.
...
States:
- Completed: Blue circle (#155EEF), white checkmark
- Active: Blue circle (#155EEF), white number
- Upcoming: Gray circle (#D1D6DB), gray number (#7E8A96)
- Error: Red circle (#F04438), white exclamation

Line Colors:
- Completed: Blue (#155EEF)
- Upcoming: Gray (#D1D6DB)
```
...
- Step counter: "Step X of Y" - 14px, gray (#7E8A96)
...
- Field label spacing: 8px above input
```
...
- Message: 16px, gray (#535D67)

Layout:
- Center-aligned content
- Icon at top
- Title below icon (16px gap)
- Message below title (12px gap)
...
```html
<div role="region" aria-label="Multi-step form">
  <!-- Progress indicator -->
  <ol role="list" aria-label="Form progress">
    <li role="listitem" aria-current="step">
      <span aria-label="Step 2 of 5: Filing Options, current step">
        Filing Options
      </span>
    </li>
  </ol>
  ...
  <div role="group" aria-labelledby="step-title">
    <h2 id="step-title">Filing Options</h2>
    <p id="step-description">Select your filing preferences</p>

    <form aria-describedby="step-description">
      <!-- Form fields -->
    </form>
  </div>
...
```
On Step Change:
"Step 3 of 5: Jurisdiction. Select the filing jurisdiction."

On Validation Error:
"Error: 2 fields require attention. Email address is required."

On Save Draft:
"Draft saved successfully."

On Submission:
"Processing patent application. Please wait."

On Success:
"Success. Patent application 12345 has been created."
```
...
**Progress Indicator:**
- Active step: Blue on white (6.5:1) ✓
- Completed step: Blue on white (6.5:1) ✓
- Inactive step: Gray on white (4.5:1) ✓
- Error step: Red on white (5.2:1) ✓

**Text:**
- All text meets WCAG AA (4.5:1 minimum)
- Error messages: Red (#F04438) on white (5.2:1)
- Success messages: Green (#17B26A) on white (3.9:1) - use icon + text
