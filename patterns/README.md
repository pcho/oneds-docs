...
Welcome to the OneDS Design Patterns documentation. This guide provides comprehensive patterns for building consistent, accessible, and user-friendly interfaces across the IP management system.

## What Are Design Patterns?

Design patterns are reusable solutions to common design problems. They provide:
- **Consistency** across the application
- **Best practices** for common interactions
- **Accessibility** built-in from the start
- **Efficiency** through reusable solutions
- **Quality** through documented standards

## Pattern Categories

Our patterns are organized into six categories based on their purpose and usage:

### 🎭 Behaviours
Common interactive patterns that define how users interact with the interface.

### 📄 Content
Patterns for displaying and organizing different types of content and data.

### 🎨 Features
Patterns for specific feature implementations and functionality.

### 🔄 Flows
Multi-step process patterns that guide users through complex tasks.

### 📐 Layouts
Structural patterns that define how content is organized on the page.

### 🧭 Navigation
Patterns for moving through and discovering content in the application.
...
Contextual toolbar for bulk operations on selected items.

**Use when:** Users need to perform actions on multiple selected items simultaneously.
