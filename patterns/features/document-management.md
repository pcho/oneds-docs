...
Document Management Systems (DMS) handle file storage, organization, versioning, and access control for documents throughout their lifecycle. In IP management, documents include patent applications, drawings, correspondence, agreements, and evidence files.
...
- Border radius: 8px
- Background: #F9FAFB
- Hover: Border #155EEF, background #EDF1FF
...
**ARIA:**
```html
<button aria-label="Upload document" aria-describedby="upload-help">
  Upload
</button>
<div id="upload-help" role="tooltip">
  Drag and drop or click to select files (PDF, DOC, max 50MB)
</div>

<div role="progressbar" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100" aria-label="Uploading technical drawing">
  65%
</div>
```
