...
AI integration brings intelligent assistance directly into workflows—helping users draft content, analyze data, suggest actions, and automate repetitive tasks. Instead of switching contexts, AI becomes a natural part of the interface, providing help exactly when and where it's needed.

This is an emerging pattern requiring early standardization to ensure consistency across all AI-powered features.
...
- Color: Green (#17B26A) when active

👎 Thumbs Down:
- Tooltip: "Bad response"
- Click: Opens feedback form
- Color: Red (#F04438) when active
...
<aside
  ...
  <!-- Conversation -->
  <div role="log" aria-label="AI conversation">

    <!-- User Message -->
    <div role="article" aria-label="You asked">
      Help me draft a patent abstract
    </div>

    <!-- AI Response -->
    <div role="article" aria-label="AI responded">
      <div aria-live="polite" aria-atomic="false">
        <!-- Streaming text -->
        A smart widget device...
      </div>
  ...
  <!-- Input -->
  <form role="search">
    <label for="ai-input">Ask AI</label>
    <textarea
      id="ai-input"
      aria-describedby="ai-hint"
      aria-required="true"></textarea>
    <span id="ai-hint">Type your question or request</span>
...
```
On Open:
"AI Assistant opened. Type your question."
...
Response Ready:
"AI has responded. Use arrow keys to navigate."

Streaming:
Don't announce every word (too verbose)
Announce when complete: "Response complete"
