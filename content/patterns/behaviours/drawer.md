...
Drawers (also called side panels) slide in from the edge of the screen to show contextual content without taking you away from the current page. Think of them as your helpful sidekicks.

## Core Concept

Drawers are semi-modal panels that:
- Slide in from the viewport edge (usually the right)
- Overlay the page with a backdrop
- Display related or detailed information
- Let you interact with their content
- Slide away when you're done
