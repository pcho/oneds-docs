---
title: Global Search
description: "Documentation for Global Search component"
---
...
Global search gives instant access to information across the entire system—one search box to find patents, contacts, documents, and more. No need to navigate through multiple pages: users jump directly to what they need with a few keystrokes.

It's your system's command center: press a key, type what you want, and go.
...
- Max height: 520px
- Overflow: Scroll
- Gap: spacing-4 between categories
```
...
- "View all" link: Right-aligned, text-base

Result Item:
- Height: Auto (min 56px)
- Padding: spacing-3 spacing-4
- Gap: spacing-1 (title to metadata)
...
- Title: text-lg, font-weight-emphasized, highlighted matches
- Metadata: text-base, txt-tertiary, secondary info
...
Size: 16px × 16px
Color: txt-secondary or entity-specific color
...
- Border left: 3px solid fill-accent (optional)
